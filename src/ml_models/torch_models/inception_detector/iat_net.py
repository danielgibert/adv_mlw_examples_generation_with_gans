...
class IATNetwork(InceptionNetwork):
    def __init__(self, network_parameters:dict):
        super(IATNetwork, self).__init__(network_parameters)
        ...
        self.dense3 = nn.Linear(
            ...
            out_features=self.network_parameters["hidden_neurons"][2]
        )
        self.dropout3 = torch.nn.Dropout(p=self.network_parameters["dropout_rate"])

        self.dense4 = nn.Linear(
            in_features=self.network_parameters["hidden_neurons"][2],
