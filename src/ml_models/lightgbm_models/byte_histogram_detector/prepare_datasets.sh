...
python create_byte_histogram_training_and_test_sets_2017.py
python create_byte_histogram_training_and_test_sets_2018.py
...
# Shuffle data
python shuffle_sets.py data/csv/clean_train_features_2017.csv data/csv/train_byte_features_2017.csv
python shuffle_sets.py data/csv/clean_test_features_2017.csv data/csv/test_byte_features_2017.csv
python shuffle_sets.py data/csv/clean_train_features_2018.csv data/csv/train_byte_features_2018.csv
python shuffle_sets.py data/csv/clean_test_features_2018.csv data/csv/test_byte_features_2018.csv