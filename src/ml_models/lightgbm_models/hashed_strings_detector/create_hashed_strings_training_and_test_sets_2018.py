...
import csv
sys.path.append("../../../../")
from adversarial_malware_samples_generation.feature_extractors.strings_statistics_extractor import StringsStatisticsExtractor
...
if __name__ == "__main__":
    ...
    feature_extractor = StringsStatisticsExtractor()
