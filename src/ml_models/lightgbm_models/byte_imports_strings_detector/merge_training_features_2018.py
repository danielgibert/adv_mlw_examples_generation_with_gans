...
training_csv_filepaths = [
    "data/csv/train_features_0_2018.csv",
    "data/csv/train_features_1_2018.csv",
    "data/csv/train_features_2_2018.csv",
    "data/csv/train_features_3_2018.csv",
    "data/csv/train_features_4_2018.csv",
    "data/csv/train_features_5_2018.csv"
]
...
if __name__ == "__main__":
    ...
    df_train.to_csv("data/csv/train_features_2018.csv", index=False)