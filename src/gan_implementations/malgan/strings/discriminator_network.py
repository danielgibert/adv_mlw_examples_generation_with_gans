...
class DiscriminatorNetwork(nn.Module):
    ...
    def __init__(self, discriminator_parameters: dict):
        ...
        self.features_size = self.discriminator_parameters["features_size"]
        ...
        self.dense3 = nn.Linear(
            ...
            out_features=self.discriminator_parameters["hidden_neurons"][2]
        )
        self.dropout3 = torch.nn.Dropout(p=self.discriminator_parameters["dropout_rate"])

        self.dense4 = nn.Linear(
            in_features=self.discriminator_parameters["hidden_neurons"][2],
            out_features=1
        )
